	    ...
	    <div class="col-md-6 col-md-offset-3">
            <div class="panel panel-primary">
                <div class="panel-body">
                    <form class="form-horizontal" role="form" method="POST" action="{{ route('productOperation.update', $product->product_id) }}">
                        ...
                        <div class="form-group{{ $errors->has('product_image') ? ' has-error' : '' }}">
                            ...
                            <div class="col-md-6">
                                <input id="product_image" type="text" class="form-control" name="product_image" value="{{ $product->product_image }}" placeholder="Input name of image fail">
                        ...
                        <div class="form-group{{ $errors->has('product_qty') ? ' has-error' : '' }}">
                            ...
                            <div class="col-md-6">
                                <input id="product_qty" type="text" class="form-control" name="product_qty" value="{{ $product->product_qty }}">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-md-6">
                                <input id="reduced_price" type="text" class="form-control" name="reduced_price" value="{{ $product->reduced_price }}" placeholder="The field does not necessarily.">
                            </div>
                        </div>
                        ...
                        <div class="form-group{{ $errors->has('product_desc') ? ' has-error' : '' }}">
                            ...
                            <div class="col-md-6">
                                <textarea id="product_desc" rows="5" class="form-control" style="resize: vertical" name="product_desc">{{ $product->product_desc }}</textarea>
